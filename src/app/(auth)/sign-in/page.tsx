    ...
    return (
        <div className="mx-auto w-full max-w-[420px]">
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            ...
                            <button type="button" className="cursor-pointer text-xs text-violet-400/70 transition-colors hover:text-violet-400">
                                Forgot?
                            </button>
                        </div>
            ...
            <p className="mt-6 text-center text-sm text-white/25">
                ...
                <Link href="/sign-up" className="text-violet-400/70 transition-colors hover:text-violet-400">
                    Create one
                </Link>
            </p>
        </div>
