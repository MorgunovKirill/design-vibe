...
export default function SignUpPage() {
    ...
    return (
        <div className="mx-auto w-full max-w-[420px]">
            {/* Card */}
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-8 backdrop-blur-xl shadow-2xl shadow-violet-500/5">
                {/* Header */}
                ...
                <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-xs">
                        <span className="bg-[#08090d] px-3 text-white/25">or continue with email</span>
                    </div>
                </div>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    <div className="space-y-2">
                        <label htmlFor="name" className="text-xs font-medium uppercase tracking-wider text-white/30">
                            Full Name
                        </label>
                        <input
                            id="name"
                    ...
                    <div className="space-y-2">
                        <label htmlFor="password" className="text-xs font-medium uppercase tracking-wider text-white/30">
                            Password
                        </label>
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-white/20 transition-colors hover:text-white/50"
                            >
                    ...
                    <p className="text-center text-xs text-white/20">
                        ...
                        <button type="button" className="cursor-pointer text-white/40 underline underline-offset-2 transition-colors hover:text-white/60">Terms</button>
                        {" "}and{" "}
                        <button type="button" className="cursor-pointer text-white/40 underline underline-offset-2 transition-colors hover:text-white/60">Privacy Policy</button>
                    </p>
                </form>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-white/25">
                ...
                <Link href="/sign-in" className="text-violet-400/70 transition-colors hover:text-violet-400">
                    Sign in
                </Link>
            </p>
        </div>
